            ...
            <div class="main-nav-inner">            
                ...
                <nav class="main-nav">
                    <ul>
                        ...
                        <li><a href="store.html">chefs</a></li>
            ...
            <header class="main-header" id="top">
                <div class="top-banner-container top-banner-container-style2">
                    ...
                    <div class="top-banner">
                        <div class="top-image">
                            <img src="img/slider-images/our-blog.png" alt="Pepperazi">
                        </div><!-- /top-image -->
...
$html = file_get_html('http://www.vegrecipesofindia.com/veg-korma-recipe-mix-vegetable-kurma/');
foreach($html->find('div#easyrecipe-33744-0') as $e)
